(function (win, doc) {
  ...
  $('.c_menu').on('click', function () {
    $('.c_nav_2').addClass('c_nav_2__active');
    $('.c_nav_2_mask').addClass('c_nav_2_mask__active');
  });

  $('.c_nav_2_mask, .c_cha').on('click', function () {
    $('.c_nav_2_mask').removeClass('c_nav_2_mask__active');
    $('.c_nav_2').removeClass('c_nav_2__active');
  });

  $('.c_nav_2_2 li').on('click', function() {
    var index = $(this).index();
    var className = $(this).find('.c_nav_details_2').attr('class');
    
    if (className && className.indexOf('c_nav_details_2__active') >= 0) {
      $(this).find('.c_nav_details_2').removeClass('c_nav_details_2__active');
      $(this).find('.c_nav_details_1').removeClass('c_nav_details_1__active');
      return;
    }
    $(this).find('.c_nav_details_2').addClass('c_nav_details_2__active');
    $(this).find('.c_nav_details_1').addClass('c_nav_details_1__active');
  });
})(window, document);
